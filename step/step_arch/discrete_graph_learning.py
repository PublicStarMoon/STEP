...
class DiscreteGraphLearning(nn.Module):
    ...
    def __init__(self, dataset_name, k, input_seq_len, output_seq_len):
        ...
        self.num_nodes = {"METR-LA": 207, "PEMS04": 307, "PEMS-BAY": 325, "PEMS08": 170, "SWAT": 51}[dataset_name]
        self.train_length = {"METR-LA": 23990, "PEMS04": 13599, "PEMS-BAY": 36482, "PEMS08": 14284, "SWAT": 459552}[dataset_name]
        ...
        self.dim_fc = {"METR-LA": 383552, "PEMS04": 217296, "PEMS-BAY": 583424, "PEMS08": 228256, "SWAT": 7352544}[dataset_name]
        ...
        ## for the dimension, see https://github.com/zezhishao/STEP/issues/1#issuecomment-1191640023
        self.dim_fc_mean = {"METR-LA": 16128, "PEMS04": 16128 * 2, "PEMS-BAY": 16128, "PEMS08": 16128 * 2, "SWAT": 16128}[dataset_name]
